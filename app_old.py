...
import json
# Removido pandas e tabula para compatibilidade com Discloud
...
def convert_pdf_to_excel(pdf_path):
    """Função simplificada - apenas extrai texto do PDF"""
    try:
        print(f"🔍 Iniciando extração de texto do PDF: {pdf_path}")
...
def extract_text_from_pdf(pdf_path):
    ...
    try:
        ...
        text = convert_pdf_to_excel(pdf_path)
...
# Funções removidas - não usamos mais pandas/tabula
